...
namespace Octopus.Shared.Variables
{
    ...
    public static class SpecialVariables
    {
        ...
        public static class Deployment
        {
            ...
            [Define(Description = "Machines that were skipped during the deployment because they went offline", Example = "machines-123,machines-124", Domain = VariableDomain.List)] public static readonly string OfflineMachines = "Octopus.Deployment.OfflineMachines";
