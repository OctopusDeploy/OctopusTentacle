...
namespace Octopus.Shared.Variables
{
    ...
    public static class SpecialVariables
    {
        ...
        public static class Action
        {
            ...
            [Define(Category = VariableCategory.Action, Description = "What type of target this action will run on", Example = "OctopusServer, DeploymentTarget", Domain = VariableDomain.Text)] public static readonly string TargetType = "Octopus.Action.TargetType";
