...
namespace Octopus.Shared.Variables
{
    ...
    public static class SpecialVariables
    {
        ...
        [Define(Category = VariableCategory.Hidden)]
        public static readonly string FailureEncountered = "OctopusFailureEncountered";
        ...
        [Define(Category = VariableCategory.Hidden)]
        public static readonly string AllowInteractivePowerShell = "OctopusAllowInteractivePowerShell";
        [Define(Category = VariableCategory.Hidden)]
        ...
        [Define(Category = VariableCategory.Hidden)]
        public static readonly string SearchForScriptsRecursively = "OctopusSearchForScriptsRecursively";
        [Define(Category = VariableCategory.Hidden)]
        ...
        [Define(Category = VariableCategory.Hidden)]
        public static readonly string NewWorkingDirectoryPath = "OctopusNewWorkingDirectoryPath";
        [Define(Category = VariableCategory.Hidden)]
        ...
        [Define(Category = VariableCategory.Hidden)]
        public static readonly string HasLatestCalamariVersion = "HasLatestCalamariVersion";
        [Define(Category = VariableCategory.Hidden)]
        ...
        {
            [Define(Description = "Controls the number of package acquisitions that will be allowed to run concurrently.", Example = "2")]
            public static readonly string MaxParallelism = "Octopus.Acquire.MaxParallelism";
            [Define(Description = "Toggle whether delta compression will be enabled when sending packages to targets.", Example = "false")]
            public static readonly string DeltaCompressionEnabled = "Octopus.Acquire.DeltaCompressionEnabled";
        }
        ...
        public static class Environment
        {
            ...
            [Define(Example = "Production")]
            public static readonly string Name = "Octopus.Environment.Name";
            [Define(Description = "The ordering applied to the environment when it is displayed on the dashboard and elsewhere", Example = "3")]
        ...
        public static class Release
        {
            ...
            [Define(Description = "Release notes associated with the release, in Markdown format", Example = "Fixes bugs 1, 2 & 3")]
            public static readonly string Notes = "Octopus.Release.Notes";

            public static class Previous
            {
                [Define(Description = "The ID of the last release of the project", Example = "releases-122")]
                public static string Id = "Octopus.Release.Previous.Id";
            ...
            {
                [Define(Description = "The ID of the release of the last successful deployment to the current environment", Example = "releases-112")]
                public static string Id = "Octopus.Release.CurrentForEnvironment.Id";
                [Define(Description = "The version number of the release the last successful deployment to the current environment", Example = "1.1.2")]
                public static string Number = "Octopus.Release.CurrentForEnvironment.Number";
            }

            public static class Channel
            {
                [Define(Description = "The ID of the channel", Example = "Channels-122")]
                public static string Id = "Octopus.Release.Channel.Id";
                [Define(Description = "The name of the channel", Example = "Channels-122")]
                public static string Name = "Octopus.Release.Channel.Name";
            }
        }
        ...
        public static class Deployment
        {
            ...
            [Define(Example = "Deploy to Production")]
            public static readonly string Name = "Octopus.Deployment.Name";
            [Define(Description = "User-provided comments on the deployment", Example = "Signed off by Alice")]
            public static readonly string Comments = "Octopus.Deployment.Comments";
            [Define(Description = "If true, the package will be freshly downloaded from the feed/repository regardless of whether it is already present on the endpoint", Example = "False", Domain = VariableDomain.Boolean)]
            public static readonly string ForcePackageDownload = "Octopus.Deployment.ForcePackageDownload";
            [Define(Description = "Specific machines being targeted by the deployment, if any", Example = "machines-123,machines-124", Domain = VariableDomain.List)]
            public static readonly string SpecificMachines = "Octopus.Deployment.SpecificMachines";
            ...
            [Define(Description = "The date and time at which the deployment was created", Example = "Tuesday 10th September 1:23 PM")]
            public static readonly string Created = "Octopus.Deployment.Created";
            [Define(Description = "The UTC date and time at which the deployment was created", Example = "10/09/2015 3:23:00 AM +00:00")]
            public static readonly string CreatedUtc = "Octopus.Deployment.CreatedUtc";
            [Define(Description = "The error causing the deployment to fail, if any", Example = "Script returned exit code 123")]
            public static readonly string Error = "Octopus.Deployment.Error";
            [Define(Description = "A detailed description of the error causing the deployment to fail", Example = "System.IO.FileNotFoundException: file C:\\Missing.txt does not exist (at...)")]
            public static readonly string ErrorDetail = "Octopus.Deployment.ErrorDetail";

            public static class CreatedBy
            {
                [Define(Description = "The ID of the user who initiated the deployment", Example = "users-123")]
                public static readonly string Id = "Octopus.Deployment.CreatedBy.Id";
                [Define(Description = "The username of the user who initiated the deployment", Example = "alice")]
                public static readonly string Username = "Octopus.Deployment.CreatedBy.Username";
                [Define(Description = "The full name of the user who initiated the deployment", Example = "Alice King")]
                public static readonly string DisplayName = "Octopus.Deployment.CreatedBy.DisplayName";
                [Define(Description = "The email address of the user who initiated the deployment", Example = "alice@example.com")]
                public static readonly string EmailAddress = "Octopus.Deployment.CreatedBy.EmailAddress";
            }

            public static class PreviousSuccessful
            {
                [Define(Description = "The ID of the previous successful deployment of this project in the target environment", Example = "deployments-122")]
                public static string Id = "Octopus.Deployment.PreviousSuccessful.Id";
            }

            public static class Tenant
            {
                [Define(Description = "The ID of the tenant", Example = "Tenants-122")]
                public static string Id = "Octopus.Deployment.Tenant.Id";
                [Define(Description = "The name of the tenant", Example = "Acme Corp.")]
                public static string Name = "Octopus.Deployment.Tenant.Name";
                [Define(Description = "Comma delimited list of tags", Example = "Importance\\High, Feature\\Telephony", Domain = VariableDomain.List)]
                public static string Tags = "Octopus.Deployment.Tenant.Tags";
            }
        }
        ...
        {
            [Define]
            public static readonly string Id = "Octopus.ProjectGroup.Id";
            [Define(Example = "Public Web Properties")]
            public static readonly string Name = "Octopus.ProjectGroup.Name";
        }

        public static class ServerTask
        {
            [Define(Example = "servertasks-123")]
            public static readonly string Id = "Octopus.Task.Id";
            [Define(Example = "Deploy release 1.2.3 to Production")]
        ...
        {
            [Define(Category = VariableCategory.Server, Description = "The default URL at which the server can be accessed", Example = "https://my-octopus")]
            public static readonly string BaseUrl = "Octopus.Web.BaseUrl";
            [Define(Description = "A path relative to `Octopus.Web.BaseUrl` at which the project can be viewed", Example = "/app/projects/projects-123")]
            public static readonly string ProjectLink = "Octopus.Web.ProjectLink";
            [Define(Description = "A path relative to `Octopus.Web.BaseUrl` at which the release can be viewed", Example = "/app/releases/releases-123")]
            public static readonly string ReleaseLink = "Octopus.Web.ReleaseLink";
            [Define(Description = "A path relative to `Octopus.Web.BaseUrl` at which the deployment can be viewed", Example = "/app/deployment/deployments-123")]
            public static readonly string DeploymentLink = "Octopus.Web.DeploymentLink";
        }

        public static class Step
        {
            [Define(Category = VariableCategory.Step, Example = "80b3ad09-eedf-40d6-9b66-cf97f5c0ffee")]
            public static readonly string Id = "Octopus.Step.Id";
            [Define(Category = VariableCategory.Step, Example = "Website")]
            public static readonly string Name = "Octopus.Step.Name";
            [Define(Category = VariableCategory.Step, Description = "The number of the step", Example = "2", Domain = VariableDomain.Number)]
            public static readonly string Number = "Octopus.Step.Number";

            public static class Status
            {
                [Define(Category = VariableCategory.Step, Description = "A code describing the current status of the step", Example = "Succeeded")]
                public static readonly string Code = "Octopus.Step.Status.Code";
                [Define(Category = VariableCategory.Step, Description = "If the step failed because of an error, a description of the error", Example = "The server could not be contacted")]
                public static readonly string Error = "Octopus.Step.Status.Error";
                [Define(Category = VariableCategory.Step, Description = "If the step failed because of an error, a full description of the error", Example = "System.Net.SocketException: The server could not be contacted (at ...)")]
                public static readonly string ErrorDetail = "Octopus.Step.Status.ErrorDetail";
            }
        }
        ...
        public static class Tentacle
        {
            ...
            {
                [Define(Description = "The path to the package file being deployed", Example = "C:\\Octopus\\Tentacle\\Packages\\OctoFx.1.2.3.nupkg")]
                ...
                [Define(Description = "The intersection of the roles targeted by the step, and those applied to the machine", Example = "web-server")]
            ...
            {
                [Define(Description = "The previous version of the package that was deployed to the Tentacle", Example = "1.2.3")]
                public static readonly string PackageVersion = "Octopus.Tentacle.PreviousInstallation.PackageVersion";
                [Define(Description = "The path to the package file previously deployed", Example = "C:\\Octopus\\Tentacle\\Packages\\OctoFx.1.2.2.nupkg")]
                public static readonly string PackageFilePath = "Octopus.Tentacle.PreviousInstallation.PackageFilePath";
                [Define(Description = "The directory into which the previous version of the package was extracted", Example = "C:\\Octopus\\Tentacle\\Apps\\Production\\OctoFx\\1.2.2")]
                public static readonly string OriginalInstalledPath = "Octopus.Tentacle.PreviousInstallation.OriginalInstalledPath";
                [Define(Description = "The directory into which the previous version of the package was deployed", Example = "C:\\InetPub\\WWWRoot\\OctoFx")]
            ...
            {
                [Define(Category = VariableCategory.Agent, Description = "The directory under which the agent installs packages", Example = "C:\\Octopus\\Tentacle\\Apps")]
                public static readonly string ApplicationDirectoryPath = "Octopus.Tentacle.Agent.ApplicationDirectoryPath";
                [Define(Category = VariableCategory.Agent, Description = "The instance name that the agent runs under", Example = "Tentacle")]
                public static readonly string InstanceName = "Octopus.Tentacle.Agent.InstanceName";
                [Define(Category = VariableCategory.Agent, Description = "The directory containing the agent's own executables", Example = "C:\\Program Files\\Octopus Deploy\\Tentacle")]
        ...
        {
            [Define(Category = VariableCategory.Action, Example = "85287bef-fe6c-4eb7-beef-74f5e5a6b5b0")]
            public static readonly string Id = "Octopus.Action.Id";
            [Define(Category = VariableCategory.Action, Example = "Website")]
            public static readonly string Name = "Octopus.Action.Name";
            [Define(Category = VariableCategory.Action, Description = "The sequence number of the action in the deployment process", Example = "5", Domain = VariableDomain.Number)]
            public static readonly string Number = "Octopus.Action.Number";
            [Define(Category = VariableCategory.Hidden)]
            public static readonly string IsTentacleDeployment = "Octopus.Action.IsTentacleDeployment";
            [Define(Category = VariableCategory.Hidden)]
            public static readonly string IsFtpDeployment = "Octopus.Action.IsFtpDeployment";
            [Define(Category = VariableCategory.Action, Description = "Whether or not the action runs on the Octopus Server", Example = "True", Domain = VariableDomain.Boolean)]
            public static readonly string RunOnServer = "Octopus.Action.RunOnServer";
            ...
            [Define(Category = VariableCategory.Action, Description = "The maximum number of machines on which the action will concurrently execute", Example = "5", Domain = VariableDomain.Number)]
            public static readonly string MaxParallelism = "Octopus.Action.MaxParallelism";
            [Define(Category = VariableCategory.Action, Description = "Whether or not the action has been skipped in the current deployment", Example = "True", Domain = VariableDomain.Boolean)]
            public static readonly string IsSkipped = "Octopus.Action.IsSkipped";
            [Define(Category = VariableCategory.Action, Description = "If set by the user, completes processing of the action without runnning further conventions/scripts", Example = "True", Domain = VariableDomain.Boolean)]
            public static readonly string SkipRemainingConventions = "Octopus.Action.SkipRemainingConventions";
            [Define(Category = VariableCategory.Hidden)]
            public static readonly string EnabledFeatures = "Octopus.Action.EnabledFeatures";

            public static class Status
            {
                [Define(Category = VariableCategory.Step, Description = "If the action failed because of an error, a description of the error", Example = "The server could not be contacted")]
                public static readonly string Error = "Octopus.Action.Status.Error";
                [Define(Category = VariableCategory.Step, Description = "If the action failed because of an error, a full description of the error", Example = "System.Net.SocketException: The server could not be contacted (at ...)")]
                public static readonly string ErrorDetail = "Octopus.Action.Status.ErrorDetail";
            }

            public static class Output
            {
                [Define(Category = VariableCategory.Output, Pattern = "Octopus.Action[_name_].Output._property_", Description = "The results of calling `Set-OctopusVariable` during an action are exposed for use in other actions using this pattern", Example = "Octopus.Action[Website].Output.WarmUpResponseTime")]
                public static readonly string Prefix = "Octopus.Action.Output";
            }

            public static class Template
            {
                [Define(Category = VariableCategory.Action, Description = "If the action is based on a step template, the ID of the template", Example = "actiontemplates-123")]
                public static readonly string Id = "Octopus.Action.Template.Id";
            ...
            public static class Package
            {
                ...
                [Define(Category = VariableCategory.Action, Description = "If true, the package will be downloaded by the Tentacle, rather than pushed by the Octopus server", Example = "False", Domain = VariableDomain.Boolean)]
                ...
                [Define(Category = VariableCategory.Action, Description = "If set, a specific directory to which the package will be copied after extraction", Example = "C:\\InetPub\\WWWRoot\\OctoFx")]
                public static readonly string CustomInstallationDirectory = "Octopus.Action.Package.CustomInstallationDirectory";

                [Define(Category = VariableCategory.Action, Description = "If true, the all files in the `Octopus.Action.Package.CustomInstallationDirectory` will be deleted before deployment", Example = "False", Domain = VariableDomain.Boolean)]
                public static readonly string CustomInstallationDirectoryShouldBePurgedBeforeDeployment =
                ...
                public static class Ssh
                {
                    ...
                    public static readonly string RootDirectoryPath = "Octopus.Action.Package.Ssh.RootDirectoryPath";
                    [Define(Category = VariableCategory.Action, Description = "The tools directory used for deployment on the target machine", Example = "/home/user/.tentacle/tools/")]
                    public static readonly string ToolsDirectoryPath = "Octopus.Action.Package.Ssh.ToolsDirectoryPath";
                    [Define(Category = VariableCategory.Action, Description = "The applications directory used for deployment on the target machine", Example = "/home/user/.tentacle/apps/")]
                    public static readonly string ApplicationsDirectoryPath = "Octopus.Action.Package.Ssh.ApplicationsDirectoryPath";
                    [Define(Category = VariableCategory.Action, Description = "The packages directory used for deployment on the target machine", Example = "/home/user/.tentacle/packages/")]
                    public static readonly string PackagesDirectoryPath = "Octopus.Action.Package.Ssh.PackagesDirectoryPath";
                    [Define(Category = VariableCategory.Action, Description = "The directory used for all of the Tentacle's temporary files", Example = "/var/tmp/tentacle/SQ-ABC123/85287bef-fe6c-4eb7-beef-74f5e5a6b5b0")]
                    public static readonly string TemporaryFilesDirectoryPath = "Octopus.Action.Package.Ssh.TempDirectoryPath";
                    [Define(Category = VariableCategory.Action, Description = "The package file being deployed on the target machine", Example = "/home/user/.tentacle/packages/OctoFx.RateService.1.2.3.nupkg.tar.gz")]
                    public static readonly string PackageFileName = "Octopus.Action.Package.Ssh.PackageFileName";
                }
            }
            ...
            public static class Ftp
            {
                ...
                [Define(Category = VariableCategory.Hidden)]
                public static readonly string Host = "Octopus.Action.Ftp.Host";
                [Define(Category = VariableCategory.Hidden)]
                public static readonly string Username = "Octopus.Action.Ftp.Username";
                [Define(Category = VariableCategory.Hidden)]
                public static readonly string Password = "Octopus.Action.Ftp.Password";
                [Define(Category = VariableCategory.Hidden)]
                public static readonly string UseFtps = "Octopus.Action.Ftp.UseFtps";
                [Define(Category = VariableCategory.Hidden)]
                public static readonly string FtpPort = "Octopus.Action.Ftp.FtpPort";
                [Define(Category = VariableCategory.Hidden)]
                public static readonly string RootDirectory = "Octopus.Action.Ftp.RootDirectory";
                [Define(Category = VariableCategory.Hidden)]
                public static readonly string DeleteDestinationFiles = "Octopus.Action.Ftp.DeleteDestinationFiles";
                [Define(Category = VariableCategory.Hidden)]
                public static readonly string UseActiveMode = "Octopus.Action.Ftp.UseActiveMode";
                [Define(Category = VariableCategory.Hidden)]
                public static readonly string SocketTimeoutMinutes = "Octopus.Action.Ftp.SocketTimeoutMinutes";
            }
            ...
            public static class Email
            {
                ...
                [Define(Category = VariableCategory.Hidden)]
                public static readonly string To = "Octopus.Action.Email.To";
                [Define(Category = VariableCategory.Hidden)]
                public static readonly string CC = "Octopus.Action.Email.CC";
                [Define(Category = VariableCategory.Hidden)]
                public static readonly string Bcc = "Octopus.Action.Email.Bcc";
                [Define(Category = VariableCategory.Hidden)]
                public static readonly string IsHtml = "Octopus.Action.Email.IsHtml";
                [Define(Category = VariableCategory.Hidden)]
                public static readonly string Subject = "Octopus.Action.Email.Subject";
                [Define(Category = VariableCategory.Hidden)]
            ...
            public static class Manual
            {
                ...
                [Define(Category = VariableCategory.Action, Description = "The teams responsible for completing a manual step", Example = "teams-123,teams-124", Domain = VariableDomain.List)]
                public static readonly string ResponsibleTeamIds = "Octopus.Action.Manual.ResponsibleTeamIds";
                ...
                public static class Output
                {
                    [Define(
                        ...
                        Description = "Notes provided by the user who completed a manual step")]
                    public static string Notes = "Manual.Notes";
                    ...
                    public static class ResponsibleUser
                    {
                        [Define(Category = VariableCategory.Output,
                            ...
                            Example = "users-123")]
                        public static readonly string Id = "Manual.ResponsibleUser.Id";
                        ...
                        [Define(Category = VariableCategory.Output,
                            ...
                            Example = "alice")]
                        public static readonly string Username = "Manual.ResponsibleUser.Username";
                        ...
                        [Define(Category = VariableCategory.Output,
                            ...
                            Example = "Alice King")]
                        public static readonly string DisplayName = "Manual.ResponsibleUser.DisplayName";
            ...
            public static class Azure
            {
                ...
                [Define(Category = VariableCategory.Action, Description = "Azure AD application client ID", Example = "8104d344-fb8f-4a49-ba1a-a6df0790f302")]
                public static readonly string ClientId = "Octopus.Action.Azure.ClientId";
                [Define(Category = VariableCategory.Action, Description = "Azure AD application tenant ID", Example = "b87c0ac7-dadf-4842-8a5f-3ba5da9ee8ba")]
                public static readonly string TenantId = "Octopus.Action.Azure.TenantId";
                [Define(Category = VariableCategory.Action, Description = "Azure AD application password", Example = "correct horse battery staple")]
                ...
                [Define(Category = VariableCategory.Action, Description = "Remove additional files on the destination that are not part of the deployment", Example = "False")]
                public static readonly string RemoveAdditionalFiles = "Octopus.Action.Azure.RemoveAdditionalFiles";
                [Define(Category = VariableCategory.Action, Description = "Do not remove the contents of the App_Data folder", Example = "False")]
                public static readonly string PreserveAppData = "Octopus.Action.Azure.PreserveAppData";
                [Define(Category = VariableCategory.Action, Description = "Apply App Offline web deploy rule", Example = "False")]
                public static readonly string AppOffline = "Octopus.Action.Azure.AppOffline";
                [Define(Category = VariableCategory.Action, Description = "Physical path relative to site root", Example = "one\\two")]
                public static readonly string PhysicalPath = "Octopus.Action.Azure.PhysicalPath";
                [Define(Category = VariableCategory.Action, Description = "Use file checksum (rather than timestamp) when syncing files", Example = "False")]
                ...
                [Define(Category = VariableCategory.Action, Description = "Log extracted Cloud Service Package", Example = "False")]
                public static readonly string LogExtractedCspkg = "Octopus.Action.Azure.LogExtractedCspkg";
                [Define(Category = VariableCategory.Action, Description = "Relative path to the *.cscfg file", Example = "AcmeService-Production.cscfg")]
                [DeprecatedAlias("OctopusAzureConfigurationFileName")]
                ...
                [Define(Category = VariableCategory.Action, Description = "Resource Group Name", Example = "AcmeResources")]
                ...
                [Define(Category = VariableCategory.Action, Description = "Resource Group template JSON", Example = "For examples see https://github.com/Azure/azure-resource-manager-schemas")]
                public static readonly string ResourceGroupTemplate = "Octopus.Action.Azure.ResourceGroupTemplate";
                [Define(Category = VariableCategory.Action, Description = "Resource Group template parameter JSON", Example = "For examples see https://github.com/Azure/azure-resource-manager-schemas")]
            ...
            public static class HealthCheck
            {
                ...
                public static readonly string IncludeMachinesInDeployment = "Octopus.Action.HealthCheck.IncludeMachinesInDeployment";
            }
        }
