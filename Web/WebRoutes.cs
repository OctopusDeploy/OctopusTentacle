...
namespace Octopus.Shared.Web
{
    public static class WebRoutes
    {
        ...
        public static class Api
        {
            ...
            {
                public static string Template = "~/api/tasks{/id}{?skip,active,environment,project,name,node,state}";
                public static string Index = "~/api/tasks{?skip,active,environment,project,name,node,state}";
