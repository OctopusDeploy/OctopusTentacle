...
namespace Octopus.Shared.Diagnostics
{
    public interface ILog
    {
        ...
        /// <returns>An <see cref="IDisposable"/> that will automatically revert the current block when disposed.</returns>
        [StringFormatMethod("messageFormat")] IDisposable OpenBlock(string messageFormat, params object[] args);
        ...
        /// <param name="args">Arguments for the format string.</param>
        /// <returns>An <see cref="IDisposable"/> that will automatically revert the current block when disposed.</returns>
        [StringFormatMethod("messageFormat")] LogCorrelator PlanFutureBlock(string messageFormat, params object[] args);
        ...
        [StringFormatMethod("messageFormat")] void WriteFormat(LogCategory category, string messageFormat, params object[] args);
        [StringFormatMethod("messageFormat")] void WriteFormat(LogCategory category, Exception error, string messageFormat, params object[] args);

        void Trace(string messageText);
        void Trace(Exception error);
        void Trace(Exception error, string messageText);
        [StringFormatMethod("messageFormat")] void TraceFormat(string messageFormat, params object[] args);
        [StringFormatMethod("format")] void TraceFormat(Exception error, string format, params object[] args);

        void Verbose(string messageText);
        void Verbose(Exception error);
        void Verbose(Exception error, string messageText);
        [StringFormatMethod("messageFormat")] void VerboseFormat(string messageFormat, params object[] args);
        [StringFormatMethod("format")] void VerboseFormat(Exception error, string format, params object[] args);

        void Info(string messageText);
        void Info(Exception error);
        void Info(Exception error, string messageText);
        [StringFormatMethod("messageFormat")] void InfoFormat(string messageFormat, params object[] args);
        [StringFormatMethod("format")] void InfoFormat(Exception error, string format, params object[] args);

        void Warn(string messageText);
        void Warn(Exception error);
        void Warn(Exception error, string messageText);
        [StringFormatMethod("messageFormat")] void WarnFormat(string messageFormat, params object[] args);
        [StringFormatMethod("format")] void WarnFormat(Exception error, string format, params object[] args);

        void Error(string messageText);
        void Error(Exception error);
        void Error(Exception error, string messageText);
        [StringFormatMethod("messageFormat")] void ErrorFormat(string messageFormat, params object[] args);
        [StringFormatMethod("format")] void ErrorFormat(Exception error, string format, params object[] args);

        void Fatal(string messageText);
        void Fatal(Exception error);
        void Fatal(Exception error, string messageText);
        [StringFormatMethod("messageFormat")] void FatalFormat(string messageFormat, params object[] args);
        [StringFormatMethod("format")] void FatalFormat(Exception error, string format, params object[] args);
