...
{
    [TestFixture]
    public class RegisterKubernetesDeploymentTargetCommandFixture : CommandFixture<RegisterKubernetesDeploymentTargetCommand>
    {
        IWritableTentacleConfiguration configuration;
        ISystemLog log;
        X509Certificate2 certificate;
        IRegisterKubernetesDeploymentTargetOperation operation;
        ...
        public void BeforeEachTest()
        {
            ...
            operation = Substitute.For<IRegisterKubernetesDeploymentTargetOperation>();
            ...
            Command = new RegisterKubernetesDeploymentTargetCommand(new Lazy<IRegisterKubernetesDeploymentTargetOperation>(() => operation),
        ...
        public void ShouldRegisterListeningTentacle()
        {
            ...
            Assert.That(operation.DefaultNamespace, Is.EqualTo("myspace"));
        ...
        void AssertPollingTentacleRegistered(string expectedServerAddress, params string[] additionalArgs)
        {
            ...
            Assert.That(operation.TenantTags.Single(), Is.EqualTo("CustomerType/VIP"));
            Assert.That(operation.Tenants.Single(), Is.EqualTo("Tenant1"));
            Assert.That(operation.DefaultNamespace, Is.EqualTo("test-namespace"));
