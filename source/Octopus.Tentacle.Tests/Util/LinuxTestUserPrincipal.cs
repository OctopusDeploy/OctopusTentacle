...
{
    internal class LinuxTestUserPrincipal
    {
        public LinuxTestUserPrincipal(string username)
        {
            ...
            RunCommand($"-c \"sudo userdel {username}\"", false);
        ...
        private static void RunCommand(string arguments, bool failOnNonZeroExitCode = true)
        {
