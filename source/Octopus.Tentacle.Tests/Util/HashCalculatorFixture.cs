...
namespace Octopus.Tentacle.Tests.Util
{
    ...
    {
        private const string TextToHash =
        ...
        private const string HashOfAbove = "81bb6ffd615914816eb0ada3c3dadb9f50dd390a";
        ...
        private Stream Stream(string input)
        {
            return new MemoryStream(Encoding.UTF8.GetBytes(input), false);
        }
    }
}