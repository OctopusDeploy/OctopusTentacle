...
namespace Octopus.Tentacle.Tests.Communications
{
    ...
    public class AssemblyMappingSerializationBinderDecoratorFixture
    {
        ...
        public void ShouldDeserializeToMappedAssembly()
        {
            ...
            var subject = new AssemblyMappingSerializationBinderDecorator(inner, "Octopus.Shared", "Octopus.Tentacle.Contracts", new ReMappedLegacyTypes("Octopus.Shared.Contracts", "Octopus.Tentacle.Contracts"));
