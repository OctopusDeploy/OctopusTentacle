    ...
    public class ScriptIsolationMutexFixture
    {
        ...
        public class TaskLockFixture
        {
            ...
            public void MessagesWhenBlockedDueToAWriteLockAreCorrect()
            {
                ...
                taskLock.GetBusyMessage("ServerTask-2", true).Should().Be("Waiting for the script in task [ServerTask-1](~/app#/tasks/ServerTask-1) to finish as as this script requires that no other Octopus scripts are executing on this target at the same time.");
            ...
            public void MessagesWhenBlockedDueToTwoReadLocksAreCorrect()
            {
                ...
                taskLock.GetBusyMessage("ServerTask-3", true).Should().Be("Waiting on scripts in tasks [ServerTask-1](~/app#/tasks/ServerTask-1) and [ServerTask-2](~/app#/tasks/ServerTask-2) to finish as this script requires that no other Octopus scripts are executing on this target at the same time.");
            ...
            public void MessagesWhenBlockedDueToMultipleReadLocksAreCorrect()
            {
                ...
                taskLock.GetBusyMessage("ServerTask-4", true).Should().Be("Waiting on scripts in tasks [ServerTask-1](~/app#/tasks/ServerTask-1), [ServerTask-2](~/app#/tasks/ServerTask-2) and [ServerTask-3](~/app#/tasks/ServerTask-3) to finish as this script requires that no other Octopus scripts are executing on this target at the same time.");
