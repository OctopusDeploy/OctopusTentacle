...
//{
//    public class PollingTentacleInstance : TentacleInstance
//    {
...
//            string name)
//            : base(testExecutionContext, log, repository, name)
//        {
//            this.serverTentacleConnectionDetails = serverTentacleConnectionDetails;
//            switch (tentacleInstanceRunnerType)
//            {
//                case TentacleInstanceRunnerType.Console:
//                    serverRunner = new PollingTentacleConsoleRunner(this, InstanceId, log, testExecutionContext);
//                    break;
//                case TentacleInstanceRunnerType.WindowsService:
//                    serverRunner = new PollingTentacleWindowsServiceRunner(this, InstanceId, log, testExecutionContext);
//                    break;
//                default:
//                    throw new ArgumentOutOfRangeException(nameof(tentacleInstanceRunnerType), tentacleInstanceRunnerType, null);
//            }
//        }
