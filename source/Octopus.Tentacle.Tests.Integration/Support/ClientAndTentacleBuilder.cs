...
namespace Octopus.Tentacle.Tests.Integration.Support
{
    public class ClientAndTentacleBuilder
    {
        ...
        private PortForwarder? BuildPortForwarder(int port)
        {
            ...
            return portForwarderModifiers.Aggregate(PortForwarderBuilder.ForwardingToLocalPort(port), (current, portForwarderModifier) => portForwarderModifier(current)).Build();
        }
