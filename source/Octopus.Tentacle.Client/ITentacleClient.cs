...
namespace Octopus.Tentacle.Client
{
    ...
    {
        Task<UploadResult> UploadFile(string fileName, string path, DataStream package, ITentacleContractLogger logger, CancellationToken cancellationToken);
        Task<DataStream?> DownloadFile(string remotePath, ITentacleContractLogger logger, CancellationToken cancellationToken);
