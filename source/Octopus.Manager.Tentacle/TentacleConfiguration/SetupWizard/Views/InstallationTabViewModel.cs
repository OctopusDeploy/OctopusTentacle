...
{
    public class InstallationTabViewModel : ViewModel, IScriptableViewModel
    {
        readonly ICommandLineRunner commandLineRunner;
        readonly IScriptableViewModel wizardModel;
        TextBoxLogger logger;

        public InstallationTabViewModel(IScriptableViewModel wizardModel, IComponentContext container)
        {
        ...
        {
            var validator = new InlineValidator<InstallationTabViewModel>();
            return validator;
        }
