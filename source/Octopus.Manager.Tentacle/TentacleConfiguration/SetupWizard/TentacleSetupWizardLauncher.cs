...
namespace Octopus.Manager.Tentacle.TentacleConfiguration.SetupWizard
{
    public class TentacleSetupWizardLauncher
    {
        ...
        public bool? ShowDialog(Window owner, string selectedInstance)
        {
            ...
            wizard.AddTab(new InstallationTabView(new InstallationTabViewModel(wizardModel, container)) {ReadyMessage = "You're ready to install an Octopus Tentacle.", SuccessMessage = "Installation complete!"});
