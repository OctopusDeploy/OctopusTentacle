...
namespace Octopus.Manager.Tentacle.Controls
{
    ...
    {
        private static readonly DependencyPropertyKey ImagePropertyKey = DependencyProperty.RegisterReadOnly("Image", typeof(ImageSource), typeof(RetinaImage), new PropertyMetadata(null));
        ...
        private static readonly bool IsRetina;
