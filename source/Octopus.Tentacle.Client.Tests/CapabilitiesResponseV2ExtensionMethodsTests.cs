...
namespace Octopus.Tentacle.Client.Tests
{
    ...
    public class CapabilitiesResponseV2ExtensionMethodsTests
    {
        ...
        {
            var capabilities = new CapabilitiesResponseV2(new List<string> { nameof(IScriptServiceV2), nameof(IAsyncClientScriptServiceV2.AbandonScriptAsync) });
        ...
        {
            var capabilities = new CapabilitiesResponseV2(new List<string> { nameof(IScriptServiceV2) });
