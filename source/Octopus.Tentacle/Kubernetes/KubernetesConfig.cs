...
namespace Octopus.Tentacle.Kubernetes
{
    public static class KubernetesConfig
    {
        ...
        public static string PodServiceAccountName => GetRequiredEnvVar($"{EnvVarPrefix}__PODSSERVICEACCOUNTNAME", "Unable to determine Kubernetes Pod service account name.");
