...
namespace Octopus.Tentacle.Diagnostics
{
    ...
    {
        private readonly List<Action<ILog>> actions = new();
        ...
        public void Add(Action<ILog> action)
        {
            actions.Add(action);
        }
        ...
        {
            Add(l => l.Info(error, messageText));
        }

        public void Warn(string messageText)
        {
            Add(l => l.Warn(messageText));
        }
        ...
        {
            Add(l => l.Warn(error, messageText));
        }

        public void Error(string messageText)
        {
            Add(l => l.Error(messageText));
        }
        ...
        {
            Add(l => l.Error(error, messageText));
        }

        public void Fatal(string messageText)
        {
            Add(l => l.Fatal(messageText));
        }
