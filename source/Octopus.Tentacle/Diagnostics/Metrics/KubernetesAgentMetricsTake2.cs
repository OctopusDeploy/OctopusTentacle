...
{
    public class KubernetesAgentMetricsTake2
    {
        ...
        public KubernetesAgentMetricsTake2(IPersistenceProvider persistenceProvider, MapFromConfigMapToEventList mapper, ISystemLog log)
        {
