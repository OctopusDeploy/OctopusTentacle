...
{
    public class StartUpPersistedInstanceRequest : StartUpInstanceRequest
    {
        /// <summary>
        ...
        public StartUpPersistedInstanceRequest(ApplicationName applicationName, string instanceName) : base(applicationName)
        {
