...
namespace Octopus.Shared.TransientFaultHandling
{
    ...
    public abstract class RetryStrategy
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Octopus.Shared.TransientFaultHandling.RetryStrategy" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Returns a default policy that implements a fixed retry interval configured with the <see cref="F:Octopus.Shared.TransientFaultHandling.RetryStrategy.DefaultClientRetryCount" /> and
        /// <see cref="F:Octopus.Shared.TransientFaultHandling.RetryStrategy.DefaultRetryInterval" /> parameters.
        ...
        /// <summary>
        /// Returns a default policy that implements a progressive retry interval configured with the <see cref="F:Octopus.Shared.TransientFaultHandling.RetryStrategy.DefaultClientRetryCount" />,
        /// <see cref="F:Octopus.Shared.TransientFaultHandling.RetryStrategy.DefaultRetryInterval" />, and <see cref="F:Octopus.Shared.TransientFaultHandling.RetryStrategy.DefaultRetryIncrement" /> parameters.
        /// The default retry policy treats all caught exceptions as transient errors.
        /// </summary>
        ...
        /// <summary>
        /// Returns a default policy that implements a random exponential retry interval configured with the <see cref="F:Octopus.Shared.TransientFaultHandling.RetryStrategy.DefaultClientRetryCount" />,
        /// <see cref="F:Octopus.Shared.TransientFaultHandling.RetryStrategy.DefaultMinBackoff" />, <see cref="F:Octopus.Shared.TransientFaultHandling.RetryStrategy.DefaultMaxBackoff" />, and
        /// <see cref="F:Octopus.Shared.TransientFaultHandling.RetryStrategy.DefaultClientBackoff" /> parameters.
        /// The default retry policy treats all caught exceptions as transient errors.
        /// </summary>
