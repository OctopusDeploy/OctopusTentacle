...
namespace Octopus.Shared.TransientFaultHandling
{
    ...
    public class ExponentialBackoff : RetryStrategy
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Octopus.Shared.TransientFaultHandling.ExponentialBackoff" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Octopus.Shared.TransientFaultHandling.ExponentialBackoff" /> class with the specified retry settings.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Octopus.Shared.TransientFaultHandling.ExponentialBackoff" /> class with the specified name and retry settings.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Octopus.Shared.TransientFaultHandling.ExponentialBackoff" /> class with the specified name, retry settings, and fast retry option.
        /// </summary>
        /// <param name="name">The name of the retry strategy.</param>
        /// <param name="retryCount">The maximum number of retry attempts.</param>
        /// <param name="minBackoff">The minimum backoff time</param>
