...
namespace Octopus.Shared.TransientFaultHandling
{
    ...
    public class FixedInterval : RetryStrategy
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Octopus.Shared.TransientFaultHandling.FixedInterval" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Octopus.Shared.TransientFaultHandling.FixedInterval" /> class with the specified number of retry attempts.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Octopus.Shared.TransientFaultHandling.FixedInterval" /> class with the specified number of retry attempts and time interval.
        /// </summary>
        /// <param name="retryCount">The number of retry attempts.</param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Octopus.Shared.TransientFaultHandling.FixedInterval" /> class with the specified number of retry attempts, time interval, and retry strategy.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Octopus.Shared.TransientFaultHandling.FixedInterval" /> class with the specified number of retry attempts, time interval, retry strategy, and fast start option.
        /// </summary>
        /// <param name="name">The retry strategy name.</param>
        /// <param name="retryCount">The number of retry attempts.</param>
        /// <param name="retryInterval">The time interval between retries.</param>
